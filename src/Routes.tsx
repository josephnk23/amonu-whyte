...
import { CartDrawer } from './components/CartModal/Cart';

// Lazy load components
const ElementDefault = lazy(() => import("./screens/ElementDefault/MainLanding").then(m => ({ default: m.ElementDefault })));
const ProductGridSection = lazy(() => import("./screens/ElementDefault/sections/ProductListing").then(m => ({ default: m.ProductGridSection })));
...
const Loading = () => (
  <><div className="flex items-center justify-center w-full h-[100vh]"><svg aria-hidden="true" role="status" className="inline w-[100px] h-[100px]  text-[#2788e6] animate-spin" viewBox="0 0 100 101" fill="#2788e6" xmlns="http://www.w3.org/2000/svg">
